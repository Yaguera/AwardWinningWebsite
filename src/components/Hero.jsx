...
const Hero = () => {
    ...
    useGSAP(()=> {
      gsap.set('#video-frame', {
        clipPath: 'polygon(14% 0%, 72% 0%, 90% 90%, 0% 96%)',
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      <div id="video-frame" className="relatice z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75"> 
          ...
          {/* texts */}
          <h1 className="special-font hero-heading absolute bottom-5 z-40 right-5 text-blue-75 subpixel-antialiased">
            G<b>a</b>ming
          </h1>

          <div className="absolute z-40 left-0 top-0 size-full">
            <div className="mt-24 px-5 sm:px-10">
              <h1 className="special-font hero-heading text-blue-100 subpixel-antialiased">
                redefi<b>n</b>e
              </h1>
      ...
      <h1 className="special-font hero-heading absolute bottom-5 right-5 -z-10 text-black subpixel-antialiased">
              G<b>a</b>ming
      </h1>
    </div>
  )
